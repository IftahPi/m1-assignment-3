...
Your job is to classify a user query into ONE of four labels:
...
4. **personal** — questions ABOUT THE USER themselves (their identity, preferences, what they've told us before). Answered from the persistent user profile, not the dataset.
   - Examples: "What do you remember about me?", "What's my name?", "What topics do I usually ask about?", "What did I tell you yesterday?"
   - Statements where the user shares info about themselves ("my name is Alice") are NOT personal — they don't ask a question; route them as structured so the agent can simply acknowledge.
...
- route: one of "structured", "unstructured", "out_of_scope", or "personal"
